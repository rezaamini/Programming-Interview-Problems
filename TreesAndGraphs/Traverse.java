...
public class Traverse {
    ...
    public static void preOrder_NonRecursive(TreeNode node)
    {
        if(node == null)
            return;
        if(node.left == null && node.right == null)
    ...
    public static void postOrder_NonRecursive(TreeNode node)
    {
        if(node == null)
            return;
        if(node.left == null && node.right == null)
    ...
    public static void main(String[] args)
    {
        ...
        inOrder(n1);
        System.out.println();
        //inOrder_NonRecursive(n1);
        //System.out.println();
        preOrder(n1);
        System.out.println();
        //preOrder_NonRecursive(n1);
        //System.out.println();
        postOrder(n1);
        System.out.println();
        //postOrder_NonRecursive(n1);
        //System.out.println();
        BFS(n1);
        System.out.println();
        //BFS_NonRecursive(n1);
